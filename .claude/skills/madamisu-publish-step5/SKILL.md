...
【観点】
Read ツールで .claude/rubrics/publish-playability.md を読み、キャラ視点エージェント用の観点に従って評価。
...
.claude/rubrics/publish-playability.md のGM視点
...
【入力】
publish/v{PUBLISH_V}/04_*.md 全ファイル
.claude/rubrics/publish-consistency.md
...
publish/v{PUBLISH_V}/04_*.md 全ファイル
publish/v{PUBLISH_V}/02_info_disclosure_matrix.md
.claude/rubrics/publish-coverage.md
...
【観点】
Read で .claude/rubrics/publish-stress-test.md のメタ読み観点を読み、メタ情報から犯人・トゥルーエンド条件・キャラ重要度ランキングを推測（確信度付き）。
...
【入力】
publish/v{PUBLISH_V}/04_*.md 全ファイル
.claude/rubrics/publish-stress-test.md の暴走観点
...
【入力】
publish/v{PUBLISH_V}/04_*.md 全ファイル
.claude/rubrics/publish-stress-test.md の消極的観点
...
.claude/rubrics/publish-proofread.md
